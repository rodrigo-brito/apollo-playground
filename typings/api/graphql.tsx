...
export interface Reactable {
    ...
    id: string;
    reactionGroups?: ReactionGroup[] | null /* A list of reactions grouped by content left on the subject. */;
...
export interface Query {
    ...
    codesOfConduct?: CodeOfConduct[] | null /* Look up a code of conduct by its key */;
...
export interface License {
    ...
    id: string;
    implementation?: string | null /* Instructions on how to implement the license */;
    ...
    spdxId?: string | null /* Short identifier specified by &lt;https://spdx.org/licenses&gt; */;
...
export interface MarketplaceCategory {
    ...
    howItWorks?: string | null /* The technical description of how apps listed in this category work with GitHub. */;
...
export interface MarketplaceListing extends Node {
    ...
    extendedDescription?: string | null /* The listing&#x27;s detailed description. */;
    ...
    howItWorks?: string | null /* A technical description of how this app works with GitHub. */;
    ...
    supportEmail?: string | null /* An email address for support for this listing&#x27;s app. */;
...
export interface GitHubMetadata {
    ...
    gitIpAddresses?: string[] | null /* IP addresses that users connect to for git operations */;
    hookIpAddresses?: string[] | null /* IP addresses that service hooks are sent from */;
    importerIpAddresses?: string[] | null /* IP addresses that the importer connects from */;
    isPasswordAuthenticationVerifiable: boolean /* Whether or not users are verified */;
    pagesIpAddresses?: string[] | null /* IP addresses for GitHub Pages&#x27; A records */;
}
...
export interface Organization extends Node, Actor, ProjectOwner, RepositoryOwner, UniformResourceLocatable {
    ...
    databaseId?: number | null /* Identifies the primary key from the database. */;
    description?: string | null /* The organization&#x27;s public profile description. */;
    ...
    organizationBillingEmail?: string | null /* The billing email for the organization. */;
    pinnedRepositories: RepositoryConnection /* A list of repositories this user has pinned to their profile */;
    project?: Project | null /* Find project by number. */;
    projects: ProjectConnection /* A list of projects under the owner. */;
...
export interface CommitComment
    ...
    id: string;
    lastEditedAt?: DateTime | null /* The moment the editor made the last edit */;
    path?: string | null /* Identifies the file path associated with the comment. */;
    position?: number | null /* Identifies the line position associated with the comment. */;
    publishedAt?: DateTime | null /* Identifies when the comment was published at. */;
    reactionGroups?: ReactionGroup[] | null /* A list of reactions grouped by content left on the subject. */;
    reactions: ReactionConnection /* A list of Reactions left on the Issue. */;
    repository: Repository /* The repository associated with this node. */;
...
export interface UserContentEditConnection {
    edges?: UserContentEditEdge[] | null /* A list of edges. */;
    nodes?: UserContentEdit[] | null /* A list of nodes. */;
    pageInfo: PageInfo /* Information to aid in pagination. */;
    totalCount: number /* Identifies the total count of items in the connection. */;
}
/* An edge in a connection. */
...
export interface OrganizationInvitation extends Node {
    createdAt: DateTime /* Identifies the date and time when the object was created. */;
    email?: string | null /* The email address of the user invited to the organization. */;
    id: string;
...
export interface PullRequestReviewComment
    ...
    position?: number | null /* The line index in the diff to which the comment applies. */;
    publishedAt?: DateTime | null /* Identifies when the comment was published at. */;
...
export interface CommitCommentThread extends Node, RepositoryNode {
    ...
    position?: number | null /* The position in the diff for the commit that the comment was made on. */;
    repository: Repository /* The repository associated with this node. */;
}
...
export interface Deployment extends Node {
    ...
    databaseId?: number | null /* Identifies the primary key from the database. */;
    environment?: string | null /* The environment to which this deployment was made. */;
    id: string;
    latestStatus?: DeploymentStatus | null /* The latest status of this deployment. */;
    payload?: string | null /* Extra information that a deployment system might need. */;
...
export interface DeploymentStatus extends Node {
    ...
    description?: string | null /* Identifies the description of the deployment. */;
...
export interface OrganizationIdentityProvider extends Node {
    ...
    issuer?: string | null /* The Issuer Entity ID for the SAML Identity Provider */;
...
export interface SearchResultItemEdge {
    ...
    textMatches?: TextMatch[] | null /* Text matches on the result found. */;
}
...
export interface UpdateTopicsPayload {
    clientMutationId?: string | null /* A unique identifier for the client performing the mutation. */;
    invalidTopicNames?: string[] | null /* Names of the provided topics that are not valid. */;
...
export interface AddProjectCardInput {
    ...
    contentId?: string | null /* The content of the card. Must be a member of the ProjectCardItem union */;
...
export interface AddPullRequestReviewInput {
    ...
    comments?: DraftPullRequestReviewComment[] | null /* The review line comments. */;
}
...
export interface MoveProjectCardInput {
    ...
    afterCardId?: string | null /* Place the new card after the card with this id. Pass null to place it at the top. */;
}
...
export interface MarketplaceListingsQueryArgs {
    ...
    after?: string | null /* Returns the elements in the list that come after the specified global ID. */;
    last?: number | null /* Returns the last _n_ elements from the list. */;
    before?: string | null /* Returns the elements in the list that come before the specified global ID. */;
    categorySlug?: string | null /* Select only listings with the given category. */;
    viewerCanAdmin?:
        | boolean
        | null /* Select listings to which user has admin access. If omitted, listings visible to theviewer are returned. */;
    adminId?: string | null /* Select listings that can be administered by the specified user. */;
    organizationId?: string | null /* Select listings for products owned by the specified organization. */;
    allStates?:
        | boolean
    ...
    slugs?: string[] | null /* Select the listings with these slugs, if they are visible to the viewer. */;
    primaryCategoryOnly?:
        | boolean
        | null /* Select only listings where the primary category matches the given category slug. */;
    withFreeTrialsOnly?: boolean | null /* Select only listings that offer a free trial. */;
}
...
export interface RateLimitQueryArgs {
    dryRun?: boolean | null /* If true, calculate the cost for the query without evaluating it */;
}
...
export interface PinnedRepositoriesOrganizationArgs {
    ...
    isLocked?: boolean | null /* If non-null, filters repositories according to whether they have been locked */;
}
...
export interface ProjectsOrganizationArgs {
    ...
    search?: string | null /* Query to search projects by, currently only searching by name. */;
    states?: ProjectState[] | null /* A list of states to filter the projects by. */;
}
...
export interface TeamsOrganizationArgs {
    ...
    query?: string | null /* If non-null, filters teams with query on team name and team slug */;
    ...
    ldapMapped?: boolean | null /* If true, filters teams that are mapped to an LDAP Group (Enterprise only) */;
...
export interface IssuesUserArgs {
    ...
    last?: number | null /* Returns the last _n_ elements from the list. */;
    before?: string | null /* Returns the elements in the list that come before the specified global ID. */;
    labels?: string[] | null /* A list of label names to filter the pull requests by. */;
...
export interface PullRequestsUserArgs {
    ...
    last?: number | null /* Returns the last _n_ elements from the list. */;
    before?: string | null /* Returns the elements in the list that come before the specified global ID. */;
    states?: PullRequestState[] | null /* A list of states to filter the pull requests by. */;
    labels?: string[] | null /* A list of label names to filter the pull requests by. */;
    headRefName?: string | null /* The head ref name to filter the pull requests by. */;
    baseRefName?: string | null /* The base ref name to filter the pull requests by. */;
...
export interface RepositoriesContributedToUserArgs {
    ...
    orderBy?: RepositoryOrder | null /* Ordering options for repositories returned from the connection */;
    isLocked?: boolean | null /* If non-null, filters repositories according to whether they have been locked */;
    includeUserRepositories?: boolean | null /* If true, include user repositories */;
    contributionTypes?:
...
export interface StarredRepositoriesUserArgs {
    ...
    last?: number | null /* Returns the last _n_ elements from the list. */;
    before?: string | null /* Returns the elements in the list that come before the specified global ID. */;
    ownedByViewer?: boolean | null /* Filters starred repositories to only return repositories owned by the viewer. */;
...
export interface LabelsRepositoryArgs {
    ...
    last?: number | null /* Returns the last _n_ elements from the list. */;
    before?: string | null /* Returns the elements in the list that come before the specified global ID. */;
    query?: string | null /* If provided, searches labels by name and description. */;
}
...
export interface MilestonesRepositoryArgs {
    ...
    last?: number | null /* Returns the last _n_ elements from the list. */;
    before?: string | null /* Returns the elements in the list that come before the specified global ID. */;
    states?: MilestoneState[] | null /* Filter by the state of the milestones. */;
...
export interface ObjectRepositoryArgs {
    ...
    expression?: string | null /* A Git revision expression suitable for rev-parse */;
}
...
export interface HistoryCommitArgs {
    ...
    last?: number | null /* Returns the last _n_ elements from the list. */;
    before?: string | null /* Returns the elements in the list that come before the specified global ID. */;
    path?: string | null /* If non-null, filters history to only show commits touching files under this path. */;
...
export interface ReviewsPullRequestArgs {
    ...
    last?: number | null /* Returns the last _n_ elements from the list. */;
    before?: string | null /* Returns the elements in the list that come before the specified global ID. */;
    states?: PullRequestReviewState[] | null /* A list of states to filter the reviews. */;
...
export interface ChildTeamsTeamArgs {
    ...
    userLogins?: string[] | null /* User logins to filter by */;
    immediateOnly?: boolean | null /* Whether to list immediate child teams or all descendant child teams. */;
}
